...
4. Keep `register-release-immediately=true` if you also want to register the release in `octopus-release-log`.
5. Run the workflow.
...
4. Optionally registers the release in `octopus-release-log` using `common-register-release.yml`.
