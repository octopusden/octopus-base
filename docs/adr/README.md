...
One file per decision, numbered in order: `0001-slug.md`, `0002-slug.md`. Each is a short note
saying what was decided and why — usually a paragraph. The value is in recording *that* a choice
was made, not in filling out a template.
...
describe why it works that way rather than some other way.
